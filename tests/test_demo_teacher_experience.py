...
from services.demo_experience import DEMO_CLASS_NAME
...
class DemoTeacherExperienceTestCase(unittest.TestCase):
    ...
    def test_teacher_can_browse_dashboard_class_detail_and_ai_suggestions(self):
        ...
        self.assertIn('AI'.encode('utf-8'), suggestions.data)
        self.assertIn('刷新 AI 建议'.encode('utf-8'), suggestions.data)
