...
> 兼容性说明：Flask/Werkzeug 已从 2.2.3 升级至 2.3.x，Flask-Session 从 0.4.0 升级至 0.8.0，以支持 Python 3.12+（ast.Str 在 3.12 废弃、3.14 移除；session_cookie_name 在新版 Werkzeug 中重命名）。Python 3.10/3.11/3.14 已验证可启动，3.12/3.13 理论兼容但未完整回归测试。
